    ...
    setup() {
        ...
        const question = ref({
            q1: [
                ...
                {t1:'接著你選擇往山裡走，', t2:'迎面瀑布轟然落下，水霧撲面而來，<br>你會有什麼舉動？'},
                {t1:'穿過瀑布後，你繼續走著，', t2:'發現不遠處有一支馱負重物的驢隊正慢慢前行，你會做出哪個選擇？'},
                {t1:'其中一隻驢看起來似乎有話想說石', t2:'你會有什麼反應？'},
                {t1:'告別驢隊，林中樹隙中有東西正在閃閃發亮，<br>', t2:'細看像是「范寬」兩字，此時你會：'},
            ],
            q2: [
                {t1:'剛走進畫中，抬頭仰望', t2:'面對眼前聳立的巨山與飛瀑<br>你的第一反應是？'},
